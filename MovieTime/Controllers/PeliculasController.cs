...
namespace MovieTime.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Fecha,Genero,Precio")] Peliculas peliculas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Fecha,Genero,Precio")] Peliculas peliculas)
        {
            if (id != peliculas.Id)
            {
                return NotFound();
